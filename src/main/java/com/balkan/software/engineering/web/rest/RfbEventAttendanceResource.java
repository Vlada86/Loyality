...
/**
 * REST controller for managing {@link com.balkan.software.engineering.domain.RfbEventAttendance}.
 */
@RestController
@RequestMapping("/api")
public class RfbEventAttendanceResource {
    ...
    public ResponseEntity<List<RfbEventAttendanceDTO>> getAllRfbEventAttendances(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
