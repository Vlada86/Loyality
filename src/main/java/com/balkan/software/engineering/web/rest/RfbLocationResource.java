...
/**
 * REST controller for managing {@link com.balkan.software.engineering.domain.RfbLocation}.
 */
@RestController
@RequestMapping("/api")
public class RfbLocationResource {
    ...
    public ResponseEntity<List<RfbLocationDTO>> getAllRfbLocations(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
