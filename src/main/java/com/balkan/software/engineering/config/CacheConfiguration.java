package com.balkan.software.engineering.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.balkan.software.engineering.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.balkan.software.engineering.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.balkan.software.engineering.domain.User.class.getName());
            createCache(cm, com.balkan.software.engineering.domain.Authority.class.getName());
